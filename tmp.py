...
the_dict = json.load(open('/Users/j4-ai/workspace/OCG/AI_search_content/2025-03-16-01-13-20.json'))
#把 candidate_items_list_final 提取
candidate_items_list_final=the_dict['candidate_items_list_final']
items=[]
for item in candidate_items_list_final:
